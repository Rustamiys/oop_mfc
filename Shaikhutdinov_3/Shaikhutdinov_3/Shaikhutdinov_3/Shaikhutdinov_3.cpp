...
// Shaikhutdinov_3.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CShaikhutdinov3App, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CShaikhutdinov3App::OnAppAbout)
...
// Создание CShaikhutdinov3App

CShaikhutdinov3App::CShaikhutdinov3App() noexcept
{

	// TODO: замените ниже строку идентификатора приложения строкой уникального идентификатора; рекомендуемый
	// формат для строки: ИмяКомпании.ИмяПродукта.СубПродукт.СведенияОВерсии
	SetAppID(_T("Shaikhutdinov3.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CShaikhutdinov3App

CShaikhutdinov3App theApp;


// Инициализация CShaikhutdinov3App

BOOL CShaikhutdinov3App::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CShaikhutdinov3Doc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CShaikhutdinov3View));
	if (!pDocTemplate)
		return FALSE;
...
// Обработчики сообщений CShaikhutdinov3App
...
void CShaikhutdinov3App::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
